...
/**
 * print_data - Printdata of ELF header.
 * @e_ident: pointer to array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * print_osabi - Print OS/ABI an ELF header.
 * @e_ident: pointer to array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
 ...
 * @e_ident: point to array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
...
/**
 * close_elf -  an ELF file.
 * @elf: descriptor of the ELF file.
 *
 * Description: when file cannot be closed - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
...
/**
 * main - printsinformation contained in the
